package com.saltdamage.ingest.service;

import com.alibaba.fastjson2.JSON;
import com.saltdamage.ingest.web.WebSocketSessionManager;
...
public class WebSocketService {
    ...
    public void pushRealtimeData(Object sensorData) {
        log.debug("推送实时数据");
    ...
    public void pushAlarm(Object alarm) {
        log.info("推送告警信息");
