...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, SensorDataMessage> sensorDataConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "salinity-transport-group");
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, SensorDataMessage.class.getName());
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SensorDataMessage> sensorDataKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, SensorDataMessage> factory =
